...
TEST_NORMALIZE_TIME(INT16)
TEST_NORMALIZE_TIME(INT32)
TEST_NORMALIZE_TIME(INT64)
TEST_NORMALIZE_TIME(UINT8)
TEST_NORMALIZE_TIME(UINT16)
TEST_NORMALIZE_TIME(UINT32)
TEST_NORMALIZE_TIME(UINT64)
TEST_NORMALIZE_TIME(DATE32)
TEST_NORMALIZE_TIME(DATE64)
TEST_NORMALIZE_TIME(TIME32)
TEST_NORMALIZE_TIME(TIME64)
TEST_NORMALIZE_TIME(TIMESTAMP)
